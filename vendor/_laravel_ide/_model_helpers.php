...
namespace App\Models {
     ...
     * @property string|null $georeferencedDate
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Tblextracciones>|Tblextracciones whereIdextracciones($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Tblextracciones>|Tblextracciones whereIdOccBd($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Tblextracciones>|Tblextracciones whereMaterialsampletype($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Tblextracciones>|Tblextracciones whereIdregistros($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Tblextracciones>|Tblextracciones whereFechaextraccion($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Tblextracciones>|Tblextracciones wherePurificationmethod($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Tblextracciones>|Tblextracciones whereMethoddeterminationconcentrationandratios($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Tblextracciones>|Tblextracciones whereAdnEnstock($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Tblextracciones>|Tblextracciones whereVolume($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Tblextracciones>|Tblextracciones whereVolumeunit($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Tblextracciones>|Tblextracciones whereConcentration($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Tblextracciones>|Tblextracciones whereConcentrationunit($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Tblextracciones>|Tblextracciones whereRatioofabsorbance260280($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Tblextracciones>|Tblextracciones whereRatioofabsorbance260230($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Tblextracciones>|Tblextracciones wherePreservationtype($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Tblextracciones>|Tblextracciones wherePreservationtemperature($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Tblextracciones>|Tblextracciones wherePreservationdatebegin($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Tblextracciones>|Tblextracciones whereQuality($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Tblextracciones>|Tblextracciones whereQualitycheckdate($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Tblextracciones>|Tblextracciones whereSieving($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Tblextracciones>|Tblextracciones whereCodigomuestrabiobanco($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Tblextracciones>|Tblextracciones whereCodigoadnbiobanco($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Tblextracciones>|Tblextracciones whereCodigogermoplasmabiobanco($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Tblextracciones>|Tblextracciones whereExtractionstaff($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Tblextracciones>|Tblextracciones whereQualityremarks($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Tblextracciones>|Tblextracciones newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Tblextracciones>|Tblextracciones newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Tblextracciones>|Tblextracciones query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class Tblextracciones extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
