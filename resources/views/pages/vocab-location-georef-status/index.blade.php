...
@section('page_title','Vocab location georef status')

@section('content')
<div class="d-flex" style="display:flex;justify-content:space-between;align-items:center;margin-bottom:12px;">
  <h1 style="margin:0;font-size:1.25rem;">Vocab location georef status</h1>
  <a href="{{ route('vocab-location-georef-status.create') }}" class="btn primary">Nuevo</a>
</div>
  ...
  <div class="card-body" style="padding:0;">
    <div style="overflow:auto;">
      <table class="table">
        <thead>
          <tr>
            <th>Georef status id</th>
            <th>Georef status value</th>
            <th>Description</th>
