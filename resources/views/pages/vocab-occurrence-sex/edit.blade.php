...
@section('page_title','Editar — Vocab occurrence sex')

@section('content')
<h1 class="h4" style="margin:0 0 12px 0;">Editar — Vocab occurrence sex #{ $item->sex_id }</h1>
...
<form method="POST" action="{{ route('vocab-occurrence-sex.update', $item) }}" class="card card-body">
  @csrf @method('PUT')
