...
@section('page_title','Vocab record level accessrights')

@section('content')
<div class="d-flex" style="display:flex;justify-content:space-between;align-items:center;margin-bottom:12px;">
  <h1 style="margin:0;font-size:1.25rem;">Vocab record level accessrights</h1>
  <a href="{{ route('vocab-record-level-access-rights.create') }}" class="btn primary">Nuevo</a>
</div>
  ...
  <div class="card-body" style="padding:0;">
    <div style="overflow:auto;">
      <table class="table">
        <thead>
          <tr>
            <th>Accessrights id</th>
            <th>Accessrights value</th>
            <th>Description</th>
