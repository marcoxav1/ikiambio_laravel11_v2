...
@section('page_title','Detalle — Tblprimersr')

@section('content')
<h1 class="h4" style="margin:0 0 12px 0;">Detalle — Tblprimersr #{ $item->idPrimers }</h1>
...
<div class="card">
  <div class="card-body">
    ...
    <div style="margin-top:12px;">
      <a class="btn" href="{{ route('TblPrimersR.edit', $item) }}">Editar</a>
      <a class="btn" href="{{ route('TblPrimersR.index') }}">Volver</a>
    </div>
  </div>
</div>
@endsection
