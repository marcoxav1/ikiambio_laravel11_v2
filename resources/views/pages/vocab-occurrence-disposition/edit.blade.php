...
@section('page_title','Editar — Vocab occurrence disposition')

@section('content')
<h1 class="h4" style="margin:0 0 12px 0;">Editar — Vocab occurrence disposition #{ $item->disposition_id }</h1>
...
<form method="POST" action="{{ route('vocab-occurrence-disposition.update', $item) }}" class="card card-body">
  @csrf @method('PUT')
