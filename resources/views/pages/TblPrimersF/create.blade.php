...
@section('page_title','Nuevo — Tblprimersf')

@section('content')
<h1 class="h4" style="margin:0 0 12px 0;">Nuevo — Tblprimersf</h1>
...
<form method="POST" action="{{ route('TblPrimersF.store') }}" class="card card-body">
  @csrf
